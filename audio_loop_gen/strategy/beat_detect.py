...
from ..util import AudioData, export_audio, crossfade
...
class BeatDetect(LoopStrategy):
    ...
    def create_loop(self) -> AudioData:
        ...
        print(f"Using BeatDetect strategy for loop")
        
        loop = type(self).slice_and_blend_loop(self.audio.audio_data, self.audio.sample_rate, self.__loop_start, self.__loop_end)
