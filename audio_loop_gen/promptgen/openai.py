...
OPENAI_CHAT_COMPLETION_SYSTEM_MESSAGE = """Act as a music expert who can create a wide variety of prompts for music generation.
...
class OpenAI(PromptGenerator):
    ...
    async def generate(self, max_count=1) -> list[LoopGenParams]:
        ...
        sys_message = OPENAI_CHAT_COMPLETION_SYSTEM_MESSAGE.format(parts="\n".join(parts), example=example)
